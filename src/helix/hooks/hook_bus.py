...
from helix.runtime.agent_event_log import AgentEventType
from helix.schemas import HelixBaseModel, Provenance
...
class HookEvent(HelixBaseModel):
...
class HookOutput(HelixBaseModel):
...
class HookRegistration(HelixBaseModel):
    event_type: AgentEventType
    handler_name: str
