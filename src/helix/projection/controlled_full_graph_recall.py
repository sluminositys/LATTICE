...
from helix.schemas import HelixBaseModel, LifecycleState, Provenance, TaskFingerprint
...
class FullGraphRecallCandidate(HelixBaseModel):
    candidate_id: str
...
class ControlledFullGraphRecallResult(HelixBaseModel):
...
class FullGraphRecallProvider(Protocol):
    def recall_candidates(
        ...
        *,
        ...
        """Return L0 recall candidates before HELIX recall safety rules are applied."""
