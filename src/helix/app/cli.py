...
from helix.db import PostgresSchemaManager
...
from helix.graph.runtime_loader import GraphRuntimeLoadError, load_graph_runtime
from helix.orchestration import run_execution, run_plan_only
from helix.runtime import FileAgentEventLog
from helix.schemas import PermissionMode
from helix.toolcall import (
    CliBackend,
...
def main(argv: list[str] | None = None) -> int:
    ...
    plan_parser = subparsers.add_parser("plan", help="Run the HELIX planning flow.")
    ...
    execute_parser = subparsers.add_parser("execute", help="Run the executable HELIX agent flow.")
    ...
    init_pg_parser = db_subparsers.add_parser(
        "init-postgres",
        help="Create HELIX core PostgreSQL tables.",
    )
