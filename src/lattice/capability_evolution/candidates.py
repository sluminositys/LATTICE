...
from lattice.schemas import LatticeBaseModel, LifecycleState, Provenance


class CandidateTool(LatticeBaseModel):
    candidate_id: str
    name: str
    tool_name: str
    runtime_backend: str
...
class CandidateWorkflow(LatticeBaseModel):
    candidate_id: str
    name: str
...
class ToolDiscoveryRecord(LatticeBaseModel):
    discovery_id: str
    name: str
    tool_name: str
    description: str
